      ...
      <div className="w-full max-w-md space-y-8 text-center">
        ...
        <div className="border-2 border-cyan-500/40 bg-slate-950 p-8 cyber-cut-reverse space-y-6">
          ...
          <button
            ...
            className="w-full py-4 bg-cyan-500 hover:bg-cyan-400 text-black font-black tracking-widest uppercase text-lg cyber-cut glow-cyan transition-all active:scale-95 flex items-center justify-center gap-3"
          >
